...
int main() {
   int pA, pB;
   int *A, *B, *C;
   cout << "First polynomial degree = ";
   cin >> pA;
   cout << "Second polynomial degree = ";
   cin >> pB;
   A = new int[pA+1];
   B = new int[pB+1];
   C = new int[pA+pB+1];
   ...
   for (int i=0; i<=pA-1; i++) {
      cout << "coefficient of x^" << pA-i << " polinomial A = ";
      cin >> k;
      A[i] = k;
   }
   cout << "constant term of polinomial A = ";
   cin >> k;
   A[pA] = k;
   for (int i=0; i<=pB-1; i++) {
      cout << "coefficient of x^" << pB-i << " polinomial B = ";
      cin >> k;
      B[i] = k;
   }
   cout << "constant term of polinomial B = ";
   cin >> k;
   B[pB] = k;
